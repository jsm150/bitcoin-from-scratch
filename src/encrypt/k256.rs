use super::{U256Type, CurvePoint, Fp, U256Wrapper};

pub type P = U256Type<0xFFFFFFFF_FFFFFFFF, 
    0xFFFFFFFF_FFFFFFFF, 
    0xFFFFFFFF_FFFFFFFF, 
    0xFFFFFFFE_FFFFFC2F>;

pub type N = U256Type<0xFFFFFFFF_FFFFFFFF, 
    0xFFFFFFFF_FFFFFFFE, 
    0xBAAEDCE6_AF48A03B, 
    0xBFD25E8C_D0364141>;
...
pub type A = U256Type<0, 0, 0, 0>;
pub type B = U256Type<0, 0, 0, 7>;
