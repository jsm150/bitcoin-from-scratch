...
use crate::encrypt::elliptic_curve::{Curve, U256Type, Fp, U256Wrapper};
...
impl Secp256k1 {
    ...
    pub const GX: U256 = GX::NUM;

    pub const GY: U256 = GY::NUM;

    pub const A: U256 = A::NUM;
    pub const B: U256 = B::NUM;

    pub fn build() -> Curve<P, A, B> {
        Curve::new(Fp::new(Self::GX), Fp::new(Self::GY))
    }
}
